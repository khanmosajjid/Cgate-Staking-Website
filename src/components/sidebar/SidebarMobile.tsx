  ...
  return (
    <div className="w-[100%] fixed z-10 ">
      ...
      >
        ...
        <div className="flex mx-8 gap-3 mt-16 md:mt-0">
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M16.9739 10.6281C17.1819 9.15706 16.123 8.3663 14.6749 7.83878L15.1447 5.84609L13.9978 5.54383L13.5405 7.48406C13.2389 7.40453 12.9293 7.32959 12.6215 7.25529L13.0822 5.30225L11.936 5L11.4659 6.99205C11.2164 6.93197 10.9714 6.87259 10.7336 6.81002L10.7349 6.80375L9.1533 6.38603L8.8482 7.68161C8.8482 7.68161 9.69912 7.8879 9.68119 7.9006C10.1456 8.0232 10.2296 8.34836 10.2157 8.60609L9.68058 10.8762C9.71256 10.8848 9.75404 10.8973 9.79982 10.9167L9.76651 10.9079C9.73821 10.9004 9.70879 10.8926 9.67859 10.885L8.92856 14.0652C8.87181 14.2144 8.72774 14.4384 8.40302 14.3533C8.41452 14.3709 7.56942 14.1333 7.56942 14.1333L7 15.5218L8.49253 15.9153C8.65598 15.9587 8.81751 16.0032 8.97739 16.0473L8.97747 16.0473C9.08916 16.0781 9.20005 16.1087 9.31024 16.1385L8.83564 18.154L9.98123 18.4563L10.4512 16.4621C10.7642 16.552 11.0679 16.6349 11.3652 16.713L10.8968 18.6977L12.0438 19L12.5184 16.9882C14.4741 17.3797 15.9447 17.2219 16.5636 15.351C17.0624 13.8447 16.5388 12.9758 15.5099 12.4092C16.2593 12.2264 16.8238 11.7051 16.9743 10.6283L16.9739 10.628L16.9739 10.6281ZM14.3533 14.5145C14.0282 15.8965 11.9828 15.3251 11.047 15.0637L11.0469 15.0637C10.9628 15.0402 10.8876 15.0192 10.8235 15.0023L11.4533 12.3321C11.5315 12.3527 11.6271 12.3754 11.7353 12.4011C12.7033 12.6308 14.6865 13.1016 14.3534 14.5145H14.3533ZM11.9295 11.1618C12.7097 11.382 14.4117 11.8624 14.7081 10.6064H14.7082C15.0108 9.32177 13.3568 8.93446 12.549 8.7453C12.4581 8.72402 12.3779 8.70525 12.3125 8.68799L11.7415 11.1098C11.7954 11.124 11.8586 11.1418 11.9295 11.1618Z"
              fill="white"
            />
          </svg>
        ...
        <div className="self-stretch flex-1 rounded-xl overflow-hidden flex flex-col items-start py-2.5 px-0 gap-[12px] text-left ml-10 font-light -mt-4">
